...
namespace Server.Mobiles
{
    public partial class OmniAI : BaseAI
    {
        ...
        public virtual bool m_CanStun
        {
            get
            {
                return (this.m_Mobile is BaseVendor || this.m_Mobile is BaseChampion);
            }
        }
        ...
        public bool TryToHeal()
        {
            ...
            //}
            else if ( !(this.m_Mobile is BaseBlue) && !(this.m_Mobile is BaseRed) && this.m_Mobile.Skills[SkillName.Healing].Value > 10.0)
            {

				Bandage m_Band = (Bandage)this.m_Mobile.Backpack.FindItemByType( typeof ( Bandage ) );
