		...
		public static void PayAssassin( Mobile m, Mobile leader )
		{
			...
			if ( CharacterDatabase.GetQuestState( m, "AssassinQuest" )  )
			{
				...
				if ( nAssassinDone > 0 && nAssassinFee > 0 )
				{
					...
					AetherGlobe.QuestEffect( nAssassinFee, m, false);
					...
					if (Utility.RandomDouble() < (0.05 ) )
					{
						...
						switch ( Utility.Random( 6 ) ) //
							...
							m.SendMessage( "As a reward for your dedication, the guild offers you a special gift.  May it help keep your blade sharp." );
						}
