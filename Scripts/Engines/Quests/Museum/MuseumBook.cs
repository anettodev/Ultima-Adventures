	...
	public class MuseumBook : Item
	{
		...
		public static void SetRumor( Mobile m, MuseumBook book )
		{
			...
			if ( book.ItemValue < 1 )
			{
				...
				book.ItemValue = (int)(book.ItemValue * (MyServerSettings.GetGoldCutRate(m, null) * .01));
			}
			...
			string dungeon = "the Dungeon of Abandon"; //not sure why it changed back to doom...Anhur  2FEB22
