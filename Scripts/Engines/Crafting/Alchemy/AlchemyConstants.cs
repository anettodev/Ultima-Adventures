namespace Server.Engines.Craft
{
	...
	#region Skill Requirements - Mana Potions

	/// <summary>Minimum skill required for lesser mana potion</summary>
	public const double SKILL_MIN_LESSER_MANA = 10.0;

	/// <summary>Maximum skill required for lesser mana potion</summary>
	public const double SKILL_MAX_LESSER_MANA = 45.0;

	/// <summary>Reagent amount for lesser mana potion</summary>
	public const int RESOURCE_BLACK_PEARL_LESSER_MANA = 2;

	/// <summary>Minimum skill required for mana potion</summary>
	public const double SKILL_MIN_MANA = 40.0;

	/// <summary>Maximum skill required for mana potion</summary>
	public const double SKILL_MAX_MANA = 80.0;

	/// <summary>Reagent amount for mana potion</summary>
	public const int RESOURCE_BLACK_PEARL_MANA = 4;

	/// <summary>Minimum skill required for greater mana potion</summary>
	public const double SKILL_MIN_GREATER_MANA = 70.0;

	/// <summary>Maximum skill required for greater mana potion</summary>
	public const double SKILL_MAX_GREATER_MANA = 100.0;

	/// <summary>Reagent amount for greater mana potion</summary>
	public const int RESOURCE_BLACK_PEARL_GREATER_MANA = 6;

	#endregion

	#region Skill Requirements - Invisibility Potions

	/// <summary>Minimum skill required for lesser invisibility potion</summary>
	public const double SKILL_MIN_LESSER_INVISIBILITY = 20.0;

	/// <summary>Maximum skill required for lesser invisibility potion</summary>
	public const double SKILL_MAX_LESSER_INVISIBILITY = 55.0;

	/// <summary>Reagent amount for lesser invisibility potion</summary>
	public const int RESOURCE_BLOODMOSS_LESSER_INVISIBILITY = 2;

	/// <summary>Minimum skill required for invisibility potion</summary>
	public const double SKILL_MIN_INVISIBILITY = 50.0;

	/// <summary>Maximum skill required for invisibility potion</summary>
	public const double SKILL_MAX_INVISIBILITY = 85.0;

	/// <summary>Reagent amount for invisibility potion</summary>
	public const int RESOURCE_BLOODMOSS_INVISIBILITY = 4;

	/// <summary>Minimum skill required for greater invisibility potion</summary>
	public const double SKILL_MIN_GREATER_INVISIBILITY = 75.0;

	/// <summary>Maximum skill required for greater invisibility potion</summary>
	public const double SKILL_MAX_GREATER_INVISIBILITY = 105.0;

	/// <summary>Reagent amount for greater invisibility potion</summary>
	public const int RESOURCE_BLOODMOSS_GREATER_INVISIBILITY = 6;

	#endregion

	#region Skill Requirements - Frostbite Potions

	/// <summary>Minimum skill required for frostbite potion</summary>
	public const double SKILL_MIN_FROSTBITE = 70.0;

	/// <summary>Maximum skill required for frostbite potion</summary>
	public const double SKILL_MAX_FROSTBITE = 100.0;

	/// <summary>Spider's Silk amount for frostbite potion</summary>
	public const int RESOURCE_SPIDERS_SILK_FROSTBITE = 3;

	/// <summary>Ginseng amount for frostbite potion</summary>
	public const int RESOURCE_GINSENG_FROSTBITE = 2;

	/// <summary>Minimum skill required for greater frostbite potion</summary>
	public const double SKILL_MIN_GREATER_FROSTBITE = 90.0;

	/// <summary>Maximum skill required for greater frostbite potion</summary>
	public const double SKILL_MAX_GREATER_FROSTBITE = 120.0;

	/// <summary>Spider's Silk amount for greater frostbite potion</summary>
	public const int RESOURCE_SPIDERS_SILK_GREATER_FROSTBITE = 5;

	/// <summary>Ginseng amount for greater frostbite potion</summary>
	public const int RESOURCE_GINSENG_GREATER_FROSTBITE = 4;

	#endregion

	#region Skill Requirements - Confusion Blast Potions

	/// <summary>Minimum skill required for confusion blast potion</summary>
	public const double SKILL_MIN_CONFUSION_BLAST = 75.0;

	/// <summary>Maximum skill required for confusion blast potion</summary>
	public const double SKILL_MAX_CONFUSION_BLAST = 105.0;

	/// <summary>Nightshade amount for confusion blast potion</summary>
	public const int RESOURCE_NIGHTSHADE_CONFUSION_BLAST = 3;

	/// <summary>Black Pearl amount for confusion blast potion</summary>
	public const int RESOURCE_BLACK_PEARL_CONFUSION_BLAST = 2;

	/// <summary>Minimum skill required for greater confusion blast potion</summary>
	public const double SKILL_MIN_GREATER_CONFUSION_BLAST = 95.0;

	/// <summary>Maximum skill required for greater confusion blast potion</summary>
	public const double SKILL_MAX_GREATER_CONFUSION_BLAST = 120.0;

	/// <summary>Nightshade amount for greater confusion blast potion</summary>
	public const int RESOURCE_NIGHTSHADE_GREATER_CONFUSION_BLAST = 5;

	/// <summary>Black Pearl amount for greater confusion blast potion</summary>
	public const int RESOURCE_BLACK_PEARL_GREATER_CONFUSION_BLAST = 4;
