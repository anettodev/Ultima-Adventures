    ...
    public class StaffOrb : Item
    {
        ...
        private class SetHomeEntry : ContextMenuEntry
        {
            ...
            public override void OnClick()
            {
                ...
                m_Mobile.SendMessage("A localização base do orb foi marcada para a sua atual localização.");
            }
        }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            else
            {
                if (m_Owner != from)
                {
                    from.SendMessage("Isto não lhe pertence. Reporte-se a um staff imediatamente para evitar problemas.");
                    this.Delete();
                    return;
                }
                else
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (m_Owner == null)
            {
                ...
                from.SendMessage("Este Orb está vinculado a você.");
                changeColor(from);
            }
            else
            {
