...
namespace Server.Items
{
	...
	/// Use: new TreasurePileAddon(TreasurePileAddonConstants.TreasurePileVariation.Large04)
	/// This file is maintained for backward compatibility but should not be used for new content.
	/// </summary>
	[Obsolete("Use TreasurePileAddon with TreasurePileVariation.Large04 instead")]
	...
	public class TreasurePile3AddonDeed : BaseAddonDeed
	{
		...
		public TreasurePile3AddonDeed()
		{
			...
			Weight = 50.0;
			Hue = 2989;
			Name = string.Format(TreasurePileAddonStringConstants.DEED_NAME_FORMAT, 8); // Large04 - #8 (largest)
		}

        public override void AddNameProperties(ObjectPropertyList list)
		{
            base.AddNameProperties(list);
			list.Add(1070722, string.Format("<BASEFONT COLOR=#8be4fc>{0}", TreasurePileAddonStringConstants.TYPE_LARGE)); // [Grande]
