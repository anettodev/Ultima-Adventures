    ...
    class ContainerFunctions
    {
		...
		public static string GetOwner( string box )
		{
			...
			if ( nGender == 1 )
			{
				male = true;
                // MALE TITLES
                string[] vName0 = new string[] { "Templ�rio", "Ladr�o", "Ilusionista", "Pr�ncipe", "Invocador", "Sacerdote", "Conjurador", "Bandido", "Bar�o", "Feiticeiro", "Cl�rigo", "Monge", "Menestrel ", "Defensor", "Cavalheiro", "M�gico", "Warlock", "Lutador", "Seeker", "Assassino", "Ranger", "B�rbaro", "Explorador", "Her�tico", "Gladiador", "S�bio", "Rogue", "Paladin", "Bard", "Divino", "Lorde", "Bandido", "Profeta", "Mercen�rio", "Aventureiro", "Encantador", "Rei", "Escoteiro", "M�stico", "Mago", "Viajante", "Invocador", "Guerreiro", "Feiticeiro", "Vidente", "Ca�ador", "Cavaleiro", "Necromante", "Xam�" };
			...
			else
			{
				male = false;
                // FEMALE TITLES
                string[] vName0 = new string[] { "Templ�ria", "Ladra", "Ilusionista", "Princesa", "Invocadora", "Sacerdote", "Conjuradora", "Bandida", "Baroa", "Feiticeira", "Cl�riga", "Monge", "Menestrel", "Defensora", "Lady", "M�gica", "Warlock", "Lutadora", "Seeker", "Assassina", "Ranger", "B�rbara", "Exploradora", "Her�tica", "Gladiadora", "S�bia", "Rogue", "Paladina", "Barda", "[m removeDivina", "Senhora", "Bandida", "Profeta", "Mercen�ria", "Aventureira", "Encantadora", "Rainha", "Escoteira", "M�stica", "Maga", "Viajante", "Invocadora", "Guerreira", "Feiticeira", "Vidente", "Ca�adora", "Paladina", "Necromante", "Xam�" };
                sName0 = vName0[Utility.RandomMinMax( 0, (vName0.Length-1) )];
				...
				{
					nNameSection = 1;
					string[] vName1 = new string[] {"Angel", "Tru", "Ang�lica", "Maria", "Nag", "Marta", "Jade", "Luz", "Flora", "Ewe", "Dale", "Ana", "Tata", "Bia", "Rose", "Rosa", "Luisa", "Joy", "Gab", "Fernanda", "Fanny", "Dani", "Dany", "Vena", "Solar", "Rute", "Nubia", "Luna", "Jackie", "Dawn", "Aurora", "Venus", "Sol", "Mary", "Judy", "Julianne", "Mona", "Leticia", "Letty", "Sonia"};
						sName1 = vName1[Utility.RandomMinMax( 0, (vName1.Length-1) )];
			...
			string[] vAdj = new string[] { "Ex�tico", "Misterioso", "Maravilhoso", "Incr�vel", "Surpreendente", "M�stico", "Surpreendente", "Magn�fico", "Fenomenal", "Fant�stico", "Incr�vel", "Extraordin�rio", "Fabuloso ", "Maravilhoso", "Glorioso", "Perdido", "F�bula", "Lend�rio", "M�tico", "Desaparecido", "Ancestral", "Ornado", "Maravilhoso", "Sagrado", "Indiz�vel", "Desconhecido", "Esquecido" };
			...
			else if ( box == "cargo" )
			{
				...
				string[] spaceTitles = new string[] { "Mec�nico(a)", "Cientista", "M�dico(a)", "Soldado(a)", "Mercen�rio(a)", "Engenheiro(a)", "Oficial M�dico(a) Chefe", "Oficial de Ci�ncias", "Conselheiro(a)", "Fuzileiro(a) Naval", "Soldado", "Soldado", "Navegador(a)", "Oficial M�dico(a)", "Oficial", "Timoneiro(a)", "Atirador(a)", "Piloto", "Oficial de Armas", "Oficial T�tico", "Bi�logo(a)", "Qu�mico(a)", "Oficial de Seguran�a", " Engenheiro(a) de Rob�tica", "Engenheiro(a) de Avi�nica", "Engenharia(a) Chefe", "Chefe de Seguran�a", "Linguista", "Bot�nico(a)", "Patologista", "Antrop�logo(a)", "Soci�logo(a)", "Primeiro Oficial", "Oficial de Log�stica", "Enfermeiro(a)" };
			...
			{
				string[] sPirate = new string[] { "Capit�o", "Primeiro(a) Imediato", "Intendente", "Co-mestre", "Mestre da Vela", "Artista do Mar", "Navegador(a)", "Mestre Artilheiro(a)", "Artilheiro(a)", "Fabricante de Vela", "Imediato", "Marinheiro(a)", "Macaco da P�lvora", "Bucaneiro(a)", "Cors�rio(a)", "Montador(a)", "Faxineiro(a)" };
