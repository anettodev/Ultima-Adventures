...
namespace Server.Items
{
	...
	/// Pacifies creatures in a 7-tile radius for 5 seconds
	/// </summary>
	public class GreaterConfusionBlastPotion : BaseConfusionBlastPotion
	{
		#region Properties
		
		/// <summary>Blast radius for greater confusion blast potion</summary>
		public override int Radius 
		{ 
			get { return ConfusionBlastConstants.GREATER_BLAST_RADIUS; } 
		}
	...
	public override void AddNameProperty( ObjectPropertyList list )
	{
		...
		list.Add( 1070722, string.Format( "<BASEFONT COLOR=#{0:X6}>[{1}]<BASEFONT COLOR=#FFFFFF>", 
			...
			ConfusionBlastStringConstants.TYPE_GREATER_CONFUSION_BLAST ) );
	}
