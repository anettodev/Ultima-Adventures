...
namespace Server.Items
{
	...
	public class DarkFatherMorphArms : BaseArmor
	{
		...
		[Constructable]
		public DarkFatherMorphArms() : base( 11018 )
		{
			Name = "Morphing Arms of the Dark Father";
			Weight = 5.0;
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			if ( this.Hue == 0x0 )
			{
				...
				list.Add( "Lower Regeant Cost 100%" );
		...
		public override bool OnEquip( Mobile from )
		{
			...
			if ( cloak != null && cloak.GetType() == typeof( DarkFatherCloak ) && 
				shirt != null && shirt.GetType() == typeof( DarkFatherMorphChest ) && 
				...
				neck != null && neck.GetType() == typeof( DarkFatherMorphGorget ) )
			{
				...
				DarkFatherMorphChest chest = from.FindItemOnLayer( Layer.InnerTorso ) as DarkFatherMorphChest;
				...
				chest.SkillBonuses.SetValues( 0, SkillName.Necromancy, 50.0 );
				chest.PhysicalBonus = 10;
				chest.FireBonus = 17;
				chest.ColdBonus = 17;
				chest.PoisonBonus = 10;
				chest.EnergyBonus = 17;
...
/*
					DarkFatherMorphArms arms = m.FindItemOnLayer( Layer.Arms ) as DarkFatherMorphArms;
					arm.Hue = 0x0;
...
*/	
		...
		public DarkFatherMorphArms( Serial serial ) : base( serial )
		{
		}
