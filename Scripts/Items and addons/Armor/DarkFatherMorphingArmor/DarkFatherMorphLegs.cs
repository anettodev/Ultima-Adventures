...
namespace Server.Items
{
	...
	public class DarkFatherMorphLegs : BaseArmor
	{
		...
		[Constructable]
		public DarkFatherMorphLegs() : base( 11014 )
		{
		...
		public override void AddNameProperties( ObjectPropertyList list )
		{
			...
			if ( this.Parent is Mobile )
			{
				...
				{
					list.Add( 1072377 ); //??
					list.Add( "Grants Dark Father Form" );
				}
			}
		}
...
*/
		...
		public override void OnRemoved(IEntity parent )
		{
			if ( parent is Mobile )
			{
				...
				&& m.FindItemOnLayer( Layer.Cloak ) is DarkFatherCloak
...
*/
		...
		public DarkFatherMorphLegs( Serial serial ) : base( serial )
		{
		}
