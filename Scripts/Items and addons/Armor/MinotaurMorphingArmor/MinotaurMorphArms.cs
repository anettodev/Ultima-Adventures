...
namespace Server.Items
{
	...
	public class MinotaurMorphArms : BaseArmor
	{
		...
		[Constructable]
		public MinotaurMorphArms() : base( 11018 )
		{
			Name = "Morphing Arms of the Minotaur";
			Weight = 5.0;
...
/*
					MinotaurMorphArms arms = m.FindItemOnLayer( Layer.Arms ) as MinotaurMorphArms;
					arm.Hue = 0x0;
...
*/	
		...
		public MinotaurMorphArms( Serial serial ) : base( serial )
		{
		}
