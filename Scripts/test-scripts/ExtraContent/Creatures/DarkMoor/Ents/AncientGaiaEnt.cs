...
namespace Server.Mobiles
{
	...
	public class AncientGaiaEnt : BaseCreature
	{
		...
		[Constructable]
		public AncientGaiaEnt() : base( AIType.AI_Mage, FightMode.Evil, 10, 1, 0.2, 0.4 )
		{
			Name = NameList.RandomName( "trees" );
			Title = "the ancient Gaian ent";
			Body = 312;
			BaseSoundID = 442;
		...
		public AncientGaiaEnt( Serial serial ) : base( serial )
		{
		}
