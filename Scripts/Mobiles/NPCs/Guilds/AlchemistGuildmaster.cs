...
namespace Server.Mobiles
{
	public class AlchemistGuildmaster : BaseGuildmaster
	{
		...
		[Constructable]
		public AlchemistGuildmaster() : base( AlchemistGuildmasterStringConstants.TITLE_ALCHEMIST )
		{
		...
		{
			SBInfos.Add( new SBAlchemistGuild() ); 
			SBInfos.Add( new SBMixologist() ); 
		...
		{
			private AlchemistGuildmaster m_AlchemistGuildmaster;
			private Mobile m_From;

			public FixEntry( AlchemistGuildmaster AlchemistGuildmaster, Mobile from ) : base( 6120, 12 )
			{
				m_AlchemistGuildmaster = AlchemistGuildmaster;
				m_From = from;
			}

			public override void OnClick()
			{
				m_AlchemistGuildmaster.BeginRepair( m_From );
			}
		}
        ...
        private class RepairTarget : Target
        {
            ...
            public RepairTarget(AlchemistGuildmaster mage) : base(12, false, TargetFlags.None)
            {
                m_AlchemistGuildmaster = mage;
            }
