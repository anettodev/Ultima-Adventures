		...
		private static CraftResourceInfo[] m_AOSLeatherInfo = new CraftResourceInfo[]
			{
				...
				new CraftResourceInfo( MaterialInfo.GetMaterialColor( "necrotic", "", 0 ), 	1034404, "Necrótico",	CraftAttributeInfo.Necrotic,	CraftResource.NecroticLeather,	typeof( NecroticLeather ),	typeof( NecroticHides ) ),
				new CraftResourceInfo( MaterialInfo.GetMaterialColor( "volcanic", "", 0 ), 	1034415, "Volcânico",	CraftAttributeInfo.Volcanic,	CraftResource.VolcanicLeather,	typeof( VolcanicLeather ),	typeof( VolcanicHides ) ),
				...
				new CraftResourceInfo( MaterialInfo.GetMaterialColor( "goliath", "", 0 ), 	1034371, "Goliático",		CraftAttributeInfo.Goliath,		CraftResource.GoliathLeather,	typeof( GoliathLeather ),	typeof( GoliathHides ) ),
