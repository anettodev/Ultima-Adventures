	...
	public class PoisonImpl : Poison
	{
		...
		public class PoisonTimer : Timer
		{
			...
			protected override void OnTick()
			{
				...
				// Always reveal hidden players when taking poison damage
				// Note: RevealingAction() is also called in Mobile.Damage(), but we ensure it here for poison specifically
