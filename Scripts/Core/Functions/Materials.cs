    ...
    class MaterialInfo
    {
		public static string GetMaterialName( Item item )
		{
			...
			if (item is BaseWeapon)
			{
				...
				else if (weapon.Resource == CraftResource.EbonyTree) { material = "�bano"; }
				else if (weapon.Resource == CraftResource.GoldenOakTree) { material = "ip�-amarelo"; }
				...
				else if (weapon.Resource == CraftResource.ElvenTree) { material = "�lfica"; }
			...
			else if (item is BaseArmor)
			{
				...
				else if (armor.Resource == CraftResource.EbonyTree) { material = "�bano"; }
				else if (armor.Resource == CraftResource.GoldenOakTree) { material = "ip�-amarelo"; }
				...
				else if (armor.Resource == CraftResource.ElvenTree) { material = "�lfica"; }
			...
			else if (item is BaseHarvestTool)
			{
                ...
                if (IsWoodenItem(item)) 
				{
					...
					else if (tool.Resource == CraftResource.EbonyTree) { material = "�bano"; }
					else if (tool.Resource == CraftResource.GoldenOakTree) { material = "ip�-amarelo"; }
					...
					else if (tool.Resource == CraftResource.ElvenTree) { material = "�lfica"; }
		...
		public static int GetMaterialColor( string color, string style, int based )
		{
            ...
            else if (color == "elven") { hue = 0x1C9; } //0x571
            else if ( color == "golden oak" ){ hue = 0x501; }
            else if (color == "cherry") { hue = 0x8D; } //0xB22
            else if (color == "rosewood") { hue = 0x66D; } // 2281 2762 2782 2850
            else if ( color == "hickory" ){ hue = 0xB8B; } // 0x921 (prateado)
