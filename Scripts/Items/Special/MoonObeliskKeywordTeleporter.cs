...
{
	public class MoonObeliskKeywordTeleporter : Item
	{
		...
		[Constructable]
		public MoonObeliskKeywordTeleporter() : base(0x115F)
		{
			Movable = false;
			m_Keyword = -1;
			m_Substring = null;
		...
		public MoonObeliskKeywordTeleporter(Serial serial) : base(serial)
		{
		}
