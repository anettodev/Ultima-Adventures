		...
		private static SkillInfo[] m_Table = new SkillInfo[58]
			{
				...
				new SkillInfo(  1, "Anatomy",			0.0,	0.0,	0.0,	"Biologist",	null,	0.15,	0.15,	0.7,	0.7 ),
				new SkillInfo(  2, "Animal Lore",		0.0,	0.0,	0.0,	"Naturalist",	null,	0.0,	0.0,	1.0,	0.7 ),
				new SkillInfo(  3, "Item Identification",	0.0,	0.0,	0.0,	"Merchant",	null,	0.0,	0.0,	1.0,	0.8 ),
				new SkillInfo(  4, "Arms Lore",			0.0,	0.0,	0.0,	"Weapon Master",	null,	0.75,	0.15,	0.1,	0.8 ),
				new SkillInfo(  5, "Parrying",			7.5,	2.5,	0.0,	"Duelist",	null,	0.75,	0.25,	0.0,	0.8 ),
				...
				new SkillInfo( 10, "Camping",			20.0,	15.0,	15.0,	"Explorer",	null,	2.0,	1.5,	1.5,	0.7 ),
				...
				new SkillInfo( 14, "Detecting Hidden",		0.0,	0.0,	0.0,	"Scout",	null,	0.0,	0.4,	0.6,	0.7 ),
				new SkillInfo( 15, "Discordance",		0.0,	2.5,	2.5,	"Demoralizer",		null,	0.0,	0.25,	0.25,	1.0 ),
				new SkillInfo( 16, "Evaluating Intelligence",	0.0,	0.0,	0.0,	"Scholar",	null,	0.0,	0.0,	1.0,	0.8 ),
				new SkillInfo( 17, "Healing",			6.0,	6.0,	8.0,	"Healer",	null,	0.6,	0.6,	0.8,	1.0 ),
				new SkillInfo( 18, "Fishing",			0.0,	0.0,	0.0,	"Fisherman",	null,	0.5,	0.5,	0.0,	0.8 ),
				new SkillInfo( 19, "Forensic Evaluation",	0.0,	0.0,	0.0,	"Detective",	null,	0.0,	0.2,	0.8,	1.0 ),
				new SkillInfo( 20, "Herding",			16.25,	6.25,	2.5,	"Shepherd",	null,	1.625,	0.625,	0.25,	0.5 ),
				new SkillInfo( 21, "Hiding",			0.0,	0.0,	0.0,	"Shade",	null,	0.0,	0.8,	0.2,	0.7 ),
				...
				new SkillInfo( 26, "Resisting Spells",		0.0,	0.0,	0.0,	"Warder",		null,	0.25,	0.25,	0.5,	0.7 ),
				new SkillInfo( 27, "Tactics",			0.0,	0.0,	0.0,	"Tactician",	null,	0.0,	0.0,	0.0,	0.8 ),
				new SkillInfo( 28, "Snooping",			0.0,	25.0,	0.0,	"Spy",	null,	0.0,	2.5,	0.0,	1.0 ),
				new SkillInfo( 29, "Musicianship",		0.0,	0.0,	0.0,	"Bard",		null,	0.0,	0.8,	0.2,	0.7 ),
				...
				new SkillInfo( 32, "Spirit Speak",		0.0,	0.0,	0.0,	"Medium",	null,	0.0,	0.0,	1.0,	0.7 ),
				...
				new SkillInfo( 36, "Taste Identification",	0.0,	0.0,	0.0,	"Praegustator",		null,	0.2,	0.0,	0.8,	0.8 ),
				new SkillInfo( 37, "Tinkering",			5.0,	2.0,	3.0,	"Tinker",	null,	0.5,	0.2,	0.3,	1.0 ),
				new SkillInfo( 38, "Tracking",			0.0,	12.5,	12.5,	"Ranger",	null,	0.0,	1.25,	1.25,	0.7 ),
				...
				new SkillInfo( 46, "Meditation",		0.0,	0.0,	0.0,	"Stoic",	null,	0.0,	0.0,	0.0,	0.5 ),
				new SkillInfo( 47, "Stealth",			0.0,	0.0,	0.0,	"Rogue",	null,	0.0,	0.0,	0.0,	1.0 ),
				new SkillInfo( 48, "Remove Trap",		0.0,	0.0,	0.0,	"Trap Specialist",	null,	0.0,	0.0,	0.0,	0.8 ),
				new SkillInfo( 49, "Necromancy",		0.0,	0.0,	0.0,	"Necromancer",	null,	0.0,	0.0,	0.0,	1.0 ),
				new SkillInfo( 50, "Focus",			0.0,	0.0,	0.0,	"Driven",	null,	0.0,	0.0,	0.0,	0.5 ),
