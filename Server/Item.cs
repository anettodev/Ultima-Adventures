...
namespace Server
{
	...
	public class Item : IEntity, IHued, IComparable<Item>, ISerializable, ISpawnable
	{
		...
		public virtual void AddLootTypeProperty( ObjectPropertyList list )
		{
			...
			else if (m_LootType == LootType.Ensouled)
				list.Add( 1061210 ); // ensouled
		}
		...
		public virtual bool CheckEnsouled() {
			return  ( m_LootType == LootType.Ensouled );	
		}
